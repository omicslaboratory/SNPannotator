.SNPannotator <- new.env()

.SNPannotator$package.name <- 'SNPannotator'
...
.SNPannotator$script.version <- '1.4.7.1'
...
.SNPannotator$ENSEMBL_API_38 <- 'https://rest.ensembl.org'

.SNPannotator$STRINGDB_API <- 'https://string-db.org/api'
