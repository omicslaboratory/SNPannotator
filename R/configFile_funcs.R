...
loadConfigurationFile = function(path, demo = FALSE)
{
  ...
  tryCatch({
    ...
    configs$general$nearestGene_type = is_character_or_default(configs$general$nearestGene_type,
                                                               'nearestGene_type',
                                                               c("IG_pseudogene" ,"scRNA" ,"translated_processed_pseudogene" ,
                                                                 "IG_J_pseudogene" ,"TR_J_pseudogene" ,"vault_RNA" ,"TR_D_gene" ,
                                                                 "sRNA" ,"TR_C_gene" ,"ribozyme" ,"IG_C_pseudogene" ,"IG_C_gene" ,
                                                                 "IG_J_gene" ,"artifact" ,"TR_V_pseudogene" ,"IG_D_gene" ,"rRNA" ,
                                                                 "scaRNA" ,"TR_J_gene" ,"unitary_pseudogene" ,"TR_V_gene" ,
                                                                 "IG_V_gene" ,"transcribed_unitary_pseudogene" ,"IG_V_pseudogene" ,
                                                                 "rRNA_pseudogene" ,"transcribed_processed_pseudogene" ,
                                                                 "transcribed_unprocessed_pseudogene" ,"snoRNA" ,"TEC" ,"miRNA" ,
                                                                 "snRNA" ,"misc_RNA" ,"unprocessed_pseudogene" ,"processed_pseudogene" ,
                                                                 "lncRNA" ,"protein_coding" ,"all" ,"pseudogene" ,"lincRNA" ,"antisense" ,"processed_transcript" ,
                                                                 "sense_intronic" ,"3prime_overlapping_ncRNA" ,"polymorphic_pseudogene" ,"sense_overlapping"),
                                                               'all',
                                                               ignore_error = FALSE)
